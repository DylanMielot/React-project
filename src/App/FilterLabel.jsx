...
export default function Label({ index, filter, onDelete, updateSelectedFilter }) {
    ...
    return <span className='badge text-bg-primary ms-1'>{filter.label}
        ...
        <button onClick={() => addParticipant('COT')}>ADD</button>

        <svg onClick={() => deleteFilter()} style={{ cursor: 'pointer' }} xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="ms-2 bi bi-trash" viewBox="0 0 16 16">
